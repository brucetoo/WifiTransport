...
public class PermissionsAdapter {
    ...
    //Request code of Setting screen
    public static final int SETTINGS_REQ_CODE = 16061;

    //Request Permission callback listener
    public interface PermissionCallbacks extends
         ...
         * @param perms request permissions
         */
     ...
     * is not yet granted.
     */
    public static boolean checkHasPermissions(Context context, String... perms) {
        // Always return true for SDK < M, let the system deal with the permissions
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            Log.i(TAG, "checkHasPermissions: API version < M, returning true by default");
            return true;
        }
     ...
     * @param requestCode request code to track this request,NOTE: must be < 256.
    ...
    public static void requestPermissions(final Object object, String rationale,
        ...
        checkCallingObjectValid(object);

        boolean shouldShowRationale = false;
        //only show rationale when at least one perm is not be granted
        for (String perm : perms) {
            shouldShowRationale =
        ...
        if (shouldShowRationale) {
            ...
            //show this dialog when the user rejected the permission request for the first time
     ...
     * {@link OnPermissionGranted} will be run if appropriate.
     *
    ...
    public static void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        // If 100% granted successful, call annotated methods
    ...
    /**
     * Execute methods those have {@link OnPermissionGranted} annotation when all request permissions
     * is be granted
     * @param object caller Activity or Fragment
    ...
    private static void runAnnotatedMethods(Object object, int requestCode) {
        ...
        for (Method method : clazz.getDeclaredMethods()) {
            if (method.isAnnotationPresent(OnPermissionGranted.class)) {
                ...
                OnPermissionGranted ann = method.getAnnotation(OnPermissionGranted.class);
    ...
    /**
     * Check the caller Object whether an Activity or Fragment,
     * if fragment is under {@link android.app.Fragment} target api must >= 23
     * @param object caller object (an Activity or Fragment)
     */
    private static void checkCallingObjectValid(Object object) {
    ...
    /**
     * AndroidAnnotation method endsWidth "_" and implements {@link org.androidannotations.api.view.HasView}
     * so we need ignore this
     * @param object caller Activity or Fragment
     * @return AndroidAnnotation method or not
     */
